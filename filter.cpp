...
{
	Set1DFilters(new LGaussianFilter1D<T>(sigma), new LGaussianFilter1D<T>(sigma));
}
...
{
	Set1DFilters(new LGaussianDerivativeFilter1D<T>(sigmaX), new LGaussianFilter1D<T>(sigmaY));
}
...
{
	Set1DFilters(new LGaussianFilter1D<T>(sigmaX), new LGaussianDerivativeFilter1D<T>(sigmaY));
}
...
{
	Set1DFilters(new LGaussianDerivativeFilter1D<T>(sigmaX), new LGaussianDerivativeFilter1D<T>(sigmaY));
}

template <class T>
LLaplacianFilter2D<T>::LLaplacianFilter2D(double sigma, int setBands) : LLogFilter2D<T>(setBands)
{
	Set1DFilters(new LGaussian2ndDerivativeFilter1D<T>(sigma), new LGaussianFilter1D<T>(sigma));
}
